...
{
    public class Evil : ModuleBase<SocketCommandContext>
    {
        [Command("evil", RunMode = RunMode.Async)]
        [Summary("evil | Be evil. Requires bot SendMessages and EmbedLinks permissions.")]
        [RequireBotPermission(GuildPermission.SendMessages)]
        [RequireBotPermission(GuildPermission.EmbedLinks)]
        public async Task Default([Remainder]string users = null)
        {
            string fileLoc = "JSON/evil.json"; // Location of the JSON file
            string message = "";
            string allUsers = "";
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(users))
                {
                    ...
                    message = $" **{Context.User.Username}** and {allUsers} are being evil together. He..he..he..he..";
                }
                else
                {
                    message = $" **{Context.User.Username}** is being evil. He..he..he..he..";
                }
