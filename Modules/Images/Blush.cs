...
namespace Yazawa_Nico.Modules.Images
{
    ...
    public class Blush : ModuleBase<SocketCommandContext>
    {
        ...
        [Summary("blush | Blush. Requires bot SendMessages and EmbedLinks permissions.")]
        [RequireBotPermission(GuildPermission.SendMessages)]
        [RequireBotPermission(GuildPermission.EmbedLinks)]
        public async Task Default([Remainder]string users = null)
        {
            string fileLoc = "JSON/blush.json"; // Location of the JSON file
            string message = "";
            string allUsers = "";
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(users))
                {
                    ...
                    message = $" **{Context.User.Username}**is blushing from {allUsers}.";
                }
                else
                {
                    message = $" **{Context.User.Username}** is blushing from themself.";
                }
